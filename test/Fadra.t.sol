...
contract FadraTest is Test {
    ...
    function setUp() public {
        ...
        assertEq(fadra.balanceOf(owner), INITIAL_SUPPLY, "Owner should have all initial supply");
    ...
    function testInitialSetup() public {
        ...
        assertEq(fadra.balanceOf(user1), INITIAL_USER_BALANCE, "User1 should have initial balance");
        assertEq(fadra.balanceOf(user2), INITIAL_USER_BALANCE, "User2 should have initial balance");
        assertEq(
    ...
    function testFeeCalculation() public {
        ...
        assertEq(marketingFee, amount * 85 / 10000, "Incorrect marketing fee");
        assertEq(
            afterFeeAmount,
